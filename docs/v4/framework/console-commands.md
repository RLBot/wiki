...
- `Set WorldInfo WorldGravityZ 0.0000001` - Zero gravity (pretty much). Setting to 0 returns it to default.
  You can also use [state setting](/v4/botmaking/manipulating-game-state) to set gravity.
...
- `Set WorldInfo TimeDilation 3` - Speeds up the game by 3 times. Can also be used to slow down the game
  with a number between 0 and 1. You can also use [state setting](/v4/botmaking/manipulating-game-state)
  to set game speed.
