...
- It is possible to lock the FPS when RLBot is active, and unlock it when you're just playing normally. See the [RLBot Specific Game Settings](/v4/miscellaneous/rlbot-specific-game-settings#cap-the-in-game-fps-to-120-for-rlbot-uncap-the-fps-during-normal-play) page for instructions on how to do this.
