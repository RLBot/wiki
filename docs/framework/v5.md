...
RLBot v5 is currently in beta.
In this beta period we will fix bugs, incorporate feedback, and potentially make minor breaking changes.
However, RLBot v5 should now be feature-complete and stable enough that people can start adopting it.

Any updates to RLBot v5 beta will be announced in the [RLBot Discord #annoucements](https://discord.com/channels/348658686962696195/352588748401410049) channel.
